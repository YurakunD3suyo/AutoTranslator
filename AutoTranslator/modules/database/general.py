...
tts_settings = [
    ("id", "BIGINT PRIMARY KEY"), # PRIMARY KEY
    ("auto_ch", "BIGINT DEFAULT NULL"),             # [VC Auto Connect] Null or ID, Default Null
    ("text_ch", "BIGINT DEFAULT NULL"),             # [Text Channel for Auto Connect] Null or ID, Default Null
    ("speed", "REAL NOT NULL DEFAULT 1"),            # [TTS Speed (Server)] 0.5~2.0, Default 1.0
    ("length_limit", "INTEGER NOT NULL DEFAULT 50"), # [Length Limit] Null or 10~100, Default 50
    ("tts_volume", "REAL NOT NULL DEFAULT 1"),       # [TTS Volume] 0.0~1.0, Default 1.0
    ("soundtext_volume", "REAL NOT NULL DEFAULT 1"), # [SoundText Volume] 0.0~1.0, Default 1.0
    ("speaker", "INTEGER DEFAULT 3"),             # [TTS Speaker ID] ID, Default 3
    ("announce_mode", "TINYINT NOT NULL DEFAULT 1"), # [Announce Mode] 0 or 1, Default 1 (On)
    ("soundtext_mode", "TINYINT NOT NULL DEFAULT 2"), # [SoundText Modes] 0~2, Default 2 (Full On) 
]

user_settings = [
    ("id", "BIGINT PRIMARY KEY"),  # PRIMARY KEY
    ("tts_speaker", "INTEGER DEFAULT NULL"),         # [User TTS Speaker] Null or ID, Default Null
    ("tts_speed", "REAL DEFAULT NULL"),               # [User TTS Speed] Null or 0.5~2.0, Default Null
]

tts_status = [
    ("id", "INTEGER PRIMARY KEY"),  # PRIMARY KEY
    ("tts_total", "INTEGER DEFAULT 0"),
]
